        ...
        return items.map(item => {
            if (item.serviceItemId) {
                ...
                if (latest) {
                    ...
                    return {
                        ...item, code: item.code || latest.code, description: item.description || latest.name,
                        unitPrice: unitPriceToUse, totalPrice: unitPriceToUse * qty, costPrice: costPriceToUse,
                        estimatedDuration: (latest.defaultDuration || 0) * qty, isFromCatalog: true
                    };
                }
            }
