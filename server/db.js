...
export const initDb = async () => {
    ...
    const migrationQueries = [
        ...
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS prisma_od_longe DECIMAL(5,2)`,
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS base_od_longe TEXT`,
        ...
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS prisma_oe_longe DECIMAL(5,2)`,
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS base_oe_longe TEXT`,
        ...
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS lens_type TEXT`,
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS lens_material TEXT`,
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS lens_treatments TEXT`,
        `ALTER TABLE optical_rxs ADD COLUMN IF NOT EXISTS usage_instructions TEXT`,
