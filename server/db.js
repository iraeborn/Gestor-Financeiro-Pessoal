...
export const initDb = async () => {
    const createQueries = [
        ...
        `CREATE TABLE IF NOT EXISTS inventory_events (id TEXT PRIMARY KEY, service_item_id TEXT REFERENCES service_items(id), type TEXT, quantity DECIMAL(15,2), branch_id TEXT, date DATE, notes TEXT, user_id TEXT, cost_unit_price DECIMAL(15,2), related_entity_id TEXT, family_id TEXT, created_at TIMESTAMP DEFAULT NOW())`,
        ...
        `CREATE TABLE IF NOT EXISTS salesperson_schedules (id TEXT PRIMARY KEY, salesperson_id TEXT REFERENCES salespeople(id), date DATE NOT NULL, family_id TEXT, deleted_at TIMESTAMP, branch_id TEXT, shift TEXT, notes TEXT)`,
    ...
    const migrationQueries = [
        ...
        `ALTER TABLE salesperson_schedules ADD COLUMN IF NOT EXISTS branch_id TEXT`,
        `ALTER TABLE salesperson_schedules ADD COLUMN IF NOT EXISTS shift TEXT`,
        `ALTER TABLE salesperson_schedules ADD COLUMN IF NOT EXISTS notes TEXT`,
