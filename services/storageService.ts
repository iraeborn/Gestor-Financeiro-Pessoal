...
// Alterado de CheckoutSession para PagarMeSession
export const createPagarMeSession = async (planId: string): Promise<{ success: boolean, url?: string, redirectUrl?: string }> => {
