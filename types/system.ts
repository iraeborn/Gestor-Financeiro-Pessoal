...
export type ViewMode = 
  ...
  | 'SYS_CONTACTS' | 'SYS_ACCESS' | 'SYS_LOGS' | 'SYS_SETTINGS' | 'SYS_BRANCHES' | 'SYS_CHAT' | 'SYS_SALESPEOPLE' | 'SYS_HELP' | 'SYS_SALES_SCHEDULE' | 'SYS_BRANCH_DETAILS' | 'SYS_GLOBAL_SCHEDULE';
